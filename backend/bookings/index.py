"""Бронирования площадок GLOBAL LINK. v6."""
import json
import os
import base64
import uuid
...
import boto3
from helpers import (
    get_conn, cors, serial,
    SCHEMA,
)
from email_templates import confirm_email, reject_email
    ...
    if method == "POST" and action == "venue_respond":
        ...
        try:
            ...
            if org_row and org_row[2]:
                ...
                html_confirm = confirm_email(org_name, venue_name, date_str, rental_amount, venue_conditions)
            ...
            if org_row2 and org_row2[2]:
                ...
                html_reject = reject_email(org_name2, venue_name, edate, venue_conditions)
