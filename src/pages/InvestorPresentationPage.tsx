    ...
    <div className="bg-[#04060e] text-white font-golos">
      ...
      <div className="fixed bottom-8 left-1/2 -translate-x-1/2 z-50 flex items-center gap-3">
        <button onClick={() => goTo(Math.max(current - 1, 0))} disabled={current === 0}
          className="w-10 h-10 rounded-full bg-white/5 border border-white/10 flex items-center justify-center text-white/40 hover:text-white disabled:opacity-20 transition-all">
