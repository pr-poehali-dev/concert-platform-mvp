...
import { CITIES, COMPANY_TYPES, ROLE_META } from "./loginTypes";
...
interface Props {
  ...
  onStep2Submit: (e: React.FormEvent) => void;
  onBack: () => void;
  onSwitchRole: () => void;
  onGoLogin: () => void;
}
...
export default function RegisterScreen({
  role, regStep, regData, showRegPassword, isLoading, error,
  onSetReg, onTogglePassword,
  onStep1Submit, onStep2Submit, onBack, onSwitchRole, onGoLogin,
}: Props) {
      ...
      <div className="relative z-10 w-full max-w-md">
        <div className="rounded-3xl border border-white/10 shadow-2xl overflow-hidden" style={{ background: "#15152a" }}>
          ...
          <div className="p-7">
            ...
            {regStep === 1 && (
              <form onSubmit={onStep1Submit} className="space-y-3">
            ...
            {regStep === 2 && (
              <form onSubmit={onStep2Submit} className="space-y-3">
                {needsCompany ? (
                  <>
