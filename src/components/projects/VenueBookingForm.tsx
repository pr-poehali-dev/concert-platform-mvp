...
export default function VenueBookingForm({
  ...
  return (
    <div className="fixed inset-0 z-[200] flex items-center justify-center p-4">
      ...
      <div className="relative z-10 w-full max-w-lg glass-strong rounded-2xl border border-neon-purple/30 overflow-hidden animate-scale-in flex flex-col max-h-[90vh]">
        {/* Шапка */}
