    ...
    <div className="space-y-6">
      ...
      {uploadModal && uploadFile && (
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
          <div className="absolute inset-0 bg-black/60 backdrop-blur-sm" onClick={() => !uploadProgress && setUploadModal(false)} />
          <div className="relative z-10 w-full max-w-md glass-strong rounded-2xl border border-white/10 p-6 shadow-2xl">
            ...
            <h3 className="font-oswald font-bold text-lg text-white mb-5 flex items-center gap-2">
              <Icon name="Upload" size={18} className="text-neon-purple" />
              Загрузка документа
            </h3>
            ...
            <div className="flex items-center gap-3 glass rounded-xl p-3 border border-white/10 mb-4">
              <div className="w-10 h-10 rounded-lg bg-neon-purple/10 flex items-center justify-center flex-shrink-0">
                <Icon name={mimeIcon(uploadFile.type) as never} size={18} className="text-neon-purple" />
              </div>
              <div className="flex-1 min-w-0">
            ...
            <div className="mb-5">
              ...
              <input
                ...
                className="w-full bg-white/5 border border-white/10 rounded-xl px-4 py-2.5 text-white text-sm placeholder:text-white/20 outline-none focus:border-neon-purple/40 transition-colors"
              />
            </div>
            ...
            <div className="flex gap-3">
              ...
              >
                {uploadProgress
                  ? <><Icon name="Loader2" size={15} className="animate-spin" /> Загружаю...</>
