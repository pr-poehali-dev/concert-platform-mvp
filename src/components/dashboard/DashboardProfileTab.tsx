    ...
    <div className="animate-fade-in max-w-3xl">
      ...
      {pwModal && (
        <div className="fixed inset-0 z-[200] flex items-center justify-center p-4">
          <div className="absolute inset-0 bg-black/70 backdrop-blur-sm" onClick={()=>{setPwModal(false);setPwError("");setPwSuccess(false);setPwForm({current:"",next:"",confirm:""}); }}/>
          <div className="relative z-10 w-full max-w-sm glass-strong rounded-2xl p-6 border border-white/10 animate-scale-in">
            <div className="flex items-center justify-between mb-5">
              ...
              <button onClick={()=>{setPwModal(false);setPwError("");setPwSuccess(false);setPwForm({current:"",next:"",confirm:""}); }} className="text-white/30 hover:text-white transition-colors">
                <Icon name="X" size={16}/>
              </button>
            </div>
            {pwSuccess ? (
              ...
              <div className="space-y-3">
                ...
                <div className="flex gap-2 pt-1">
                  <button onClick={()=>{setPwModal(false);setPwError("");setPwForm({current:"",next:"",confirm:""}); }}
