...
export default function VenueSetupModal({ open, onClose, onCreated }: VenueSetupModalProps) {
  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-start justify-center p-4 overflow-y-auto">
      ...
      <div className="relative z-10 w-full max-w-2xl glass-strong rounded-2xl animate-scale-in flex flex-col my-auto overflow-hidden" style={{ maxHeight: "calc(100dvh - 32px)" }}>
