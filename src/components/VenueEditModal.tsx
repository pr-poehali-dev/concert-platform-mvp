...
export default function VenueEditModal({ venue, onClose, onSaved }: Props) {
  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-start justify-center p-4 overflow-y-auto">
      ...
      <div className="relative z-10 w-full max-w-2xl glass-strong rounded-2xl overflow-hidden animate-scale-in flex flex-col my-auto" style={{ maxHeight: "calc(100dvh - 32px)" }}>
